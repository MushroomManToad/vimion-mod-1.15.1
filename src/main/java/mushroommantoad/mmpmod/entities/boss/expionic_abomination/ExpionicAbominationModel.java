...
public class ExpionicAbominationModel<T extends Entity> extends EntityModel<T> {
	...
	public ExpionicAbominationModel() 
	{
		...
		Head.addBox(-3.0F, -3.0F, -3.0F, 6, 3, 6, 0.0F);
		...
		Spike.addBox(-0.5F, -0.5F, 0.0F, 1, 1, 5, 0.0F);

		Torso = new ModelRenderer(this);
		Torso.setRotationPoint(0.0F, 2.0F, 0.0F);
		Torso.setTextureOffset(232, 15);
		Torso.addBox(-4.0F, -8.0F, -2.0F, 8, 16, 4, 0.0F);
		...
		LeftWing.addBox(-1.0F, -1.0F, -0.5F, 7, 1, 1, 0.0F);
		LeftWing.setTextureOffset(214, 0);
		LeftWing.addBox(2.0F, -4.75F, 0.0F, 9, 25, 0, 0.0F);
		...
		LeftCoreBone.addBox(-0.5F, -6.5F, -0.5F, 1, 16, 1, 0.0F);
		...
		LeftLeftBone.addBox(4.5F, -2.0F, -0.475F, 1, 6, 1, 0.0F);
		...
		LeftRightBone.addBox(3.5F, -11.0F, -0.475F, 1, 6, 1, 0.0F);
		...
		RightWing.addBox(-6.0F, -1.0F, -0.5F, 7, 1, 1, 0.0F);
		RightWing.setTextureOffset(238, 35);
		RightWing.addBox(-11.0F, -4.75F, 0.0F, 9, 25, 0, 0.0F);
		...
		RightCoreBone.addBox(-0.5F, -6.5F, -0.5F, 1, 16, 1, 0.0F);
		...
		RightLeftBone.addBox(-5.5F, -2.0F, -0.475F, 1, 6, 1, 0.0F);
	...
	public void render(@Nonnull MatrixStack matrix, @Nonnull IVertexBuilder vertexBuilder, int light, int overlayLight, float red, float green, float blue, float alpha) 
	{
		...
		Torso.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
		LeftWing.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
		RightWing.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
		Tail.render(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
	}
	
	@Override
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float yaw, float pitch)
	{
