...
public class VimionicAbominationModel extends EntityModel<VimionicAbominationEntity> {
	...
	public VimionicAbominationModel() {
		...
		rightarm.func_228301_a_(-1.8706F, -2.483F, -2.0F, 4, 12, 4, 0.0F);

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, 0.0F, 0.0F);
		core.addChild(body);
		body.setTextureOffset(232, 34);
		body.func_228301_a_(-4.0F, -38.0F, -2.0F, 8, 12, 4, 0.0F);

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, -38.0F, 0.0F);
		core.addChild(head);
		head.setTextureOffset(224, 18);
		head.func_228301_a_(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F);
		head.setTextureOffset(220, 0);
		head.func_228301_a_(-4.5F, -8.5F, -4.5F, 9, 9, 9, 0.0F);
		...
		leftarm.func_228301_a_(-2.2868F, -2.4096F, -2.0F, 4, 12, 4, 0.0F);
		...
		leftleg.func_228301_a_(-1.9653F, -0.197F, -2.0F, 4, 12, 4, 0.0F);
		...
		rightleg.func_228301_a_(-2.0347F, -0.197F, -2.0F, 4, 12, 4, 0.0F);
		...
		tendril2.func_228301_a_(-35.0F, -5.0F, 25.0F, 10, 5, 10, 0.0F);
		tendril2.setTextureOffset(52, 0);
		tendril2.func_228301_a_(-33.0F, -12.0F, 24.0F, 9, 7, 9, 0.0F);
		tendril2.setTextureOffset(39, 85);
		tendril2.func_228301_a_(-31.0F, -21.0F, 23.0F, 8, 9, 8, 0.0F);
		...
		p2.func_228301_a_(-13.5797F, -53.1731F, 5.8829F, 2, 17, 2, 0.0F);
		...
		p3.func_228301_a_(-33.6147F, -27.6315F, 21.2125F, 7, 11, 7, 0.0F);
		...
		p8.func_228301_a_(-0.1843F, -4.7966F, -4.7805F, 6, 13, 6, 0.0F);
		...
		p9.func_228301_a_(-46.6955F, -36.3189F, -4.7583F, 4, 15, 4, 0.0F);

		tendril1 = new ModelRenderer(this);
		tendril1.setRotationPoint(0.0F, 24.0F, 0.0F);
		tendril1.setTextureOffset(0, 0);
		tendril1.func_228301_a_(-35.0F, -5.0F, 25.0F, 10, 5, 10, 0.0F);
		tendril1.setTextureOffset(27, 16);
		tendril1.func_228301_a_(-33.0F, -12.0F, 24.0F, 9, 7, 9, 0.0F);
		tendril1.setTextureOffset(44, 49);
		tendril1.func_228301_a_(-31.0F, -21.0F, 23.0F, 8, 9, 8, 0.0F);
		...
		p7.func_228301_a_(-13.5797F, -53.1731F, 5.8829F, 2, 17, 2, 0.0F);
		...
		p4.func_228301_a_(-33.6147F, -27.6315F, 21.2125F, 7, 11, 7, 0.0F);
		...
		p5.func_228301_a_(-0.1843F, -4.7966F, -4.7805F, 6, 13, 6, 0.0F);
		...
		p6.func_228301_a_(-46.6955F, -36.3189F, -4.7583F, 4, 15, 4, 0.0F);
	}
	...
	public void func_225598_a_(@Nonnull MatrixStack matrix, @Nonnull IVertexBuilder vertexBuilder, int light, int overlayLight, float red, float green, float blue, float alpha)
	{
		...
		tendril2.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
		tendril1.func_228309_a_(matrix, vertexBuilder, light, overlayLight, red, green, blue, alpha);
	}
	...
	@Override
	public void func_225597_a_(VimionicAbominationEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float yaw, float pitch)
	{
