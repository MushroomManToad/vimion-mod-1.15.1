...
public class SpectralChickenModel extends EntityModel<SpectralChickenEntity>
{
   ...
   public void setRotationAngles(SpectralChickenEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
