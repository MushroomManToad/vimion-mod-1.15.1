...
@OnlyIn(Dist.CLIENT)
public class SpectralSheepWoolModel<T extends SpectralSheepEntity> extends QuadrupedModel<T> 
{
	   private float headRotationAngleX;

	   // What could break if I just steal the Sheep Code, amiright?
	   public SpectralSheepWoolModel() {
