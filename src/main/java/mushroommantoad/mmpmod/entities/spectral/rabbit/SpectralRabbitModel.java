...
public class SpectralRabbitModel extends EntityModel<SpectralRabbitEntity>
{
	   ...
	   public void render(SpectralRabbitEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
	   ...
	   public void setRotationAngles(SpectralRabbitEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
