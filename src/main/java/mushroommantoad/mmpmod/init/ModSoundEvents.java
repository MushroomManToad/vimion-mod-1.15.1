...
public class ModSoundEvents 
{
	...
	public static void registerAll(RegistryEvent.Register<SoundEvent> event, Logger logger)
	{
		...
		(
				...
				solarionic_abomination_say.setRegistryName(location("solarionic_abomination_say")),
				solarionic_abomination_hurt.setRegistryName(location("solarionic_abomination_hurt")),
				solarionic_abomination_death.setRegistryName(location("solarionic_abomination_death")),
				solarionic_abomination_burn.setRegistryName(location("solarionic_abomination_burn")),
				solarionic_abomination_solarblast.setRegistryName(location("solarionic_abomination_solarblast")),
				solarionic_abomination_fireblast.setRegistryName(location("solarionic_abomination_fireblast")),
				solarionic_abomination_ascend.setRegistryName(location("solarionic_abomination_ascend")),
